  ...
  return (
    <>
      ...
      <div className="flex w-72 flex-col gap-6 mx-auto items-center">
        ...
        <Input color="blue" label="Nombre del Curso" />
        <Input color="blue" label="Valor del Curso " />
        <Input color="purple" label="Informacion" type="text" />
        <Input color="indigo" label="Fecha" type="date" />
        <Input color="purple" label="Duracion del Curso" type="text" />
